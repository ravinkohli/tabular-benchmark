...
benchmarks = [{"task": "regression",
                ...
                {"task": "classif",
                    "dataset_size": "medium",
                    "categorical": False,
                    "name": "custom_classification_all_preprocessing",
                    "include": [44120, 44121, 44122, 44123, 44124, 44125, 44126, 44127, 44128, 44129, 44130, 44131, 44089, 44090, 44091],
                    "exclude": [],
                 },
                 {"task": "classif",
                    "dataset_size": "medium",
                    "categorical": True,
                    "name": "custom_classification_no_preprocessing",
                    "include": [44120, 44121, 44122, 44123, 44124, 44125, 44126, 44127, 44128, 44129, 44130, 44131, 44089, 44090, 44091],
                    "exclude": [],
                 },
                 {"task": "classif",
                    "dataset_size": "large",
                    "categorical": False,
                    "name": "custom_classification_all_preprocessing_large",
                    "include": [44120, 44121, 44122, 44123, 44124, 44125, 44126, 44127, 44128, 44129, 44130, 44131, 44089, 44090, 44091],
                    "exclude": [],
                 },
                 {"task": "classif",
                    "dataset_size": "large",
                    "categorical": True,
                    "name": "custom_classification_no_preprocessing_large",
                    "include": [44120, 44121, 44122, 44123, 44124, 44125, 44126, 44127, 44128, 44129, 44130, 44131, 44089, 44090, 44091],
                    "exclude": [],
                 },
                # {"task": "classif",
        ...
        for model_name in models:
            ...
            for i, benchmark in enumerate(benchmarks):
                for default in default_list:
                    ...
                    name += "_{}".format(n)
                    # check if suite id is present or not
                    suite_id = benchmark.get("suite_id", None)
                    if suite_id is None:
                        datasets_to_use = benchmark["include"]
                    else:
